...
export const PRESET_LOADING_STAGE_MS = 4000;
export const PRESET_STREAM_INTERVAL_MS = 30;
...
export const PRESET_CHAT_RESPONSES: readonly PresetChatResponse[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      "- **Escalation is happening earlier:** Median time to escalation declined from roughly **8.4 to 7.3 months**, which could support a larger launch-ready patient pool for Obi.",
